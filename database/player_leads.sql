...
create table if not exists public.player_leads (
  ...
  email_confirmation_reminder_sent_at timestamptz,
  email_confirmation_reminder_count integer not null default 0,
...
alter table public.player_leads
  ...
  add column if not exists email_confirmation_reminder_sent_at timestamptz,
  add column if not exists email_confirmation_reminder_count integer not null default 0,
